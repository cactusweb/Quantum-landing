  ...
  return (
    <>
      <Head>
        ...
        <title>QuantumIO | Privacy Policy</title>
      </Head>
      <Nav isExternal />
      <Container>
        <LeftColumn>
          ...
          <SideLink href="#3">Personnel</SideLink>
          <SideLink href="#4">Sale of Business</SideLink>
          <SideLink href="#5">Affiliates</SideLink>
          <SideLink href="#6">Governing Law</SideLink>
          ...
          <SideLink href="#11">Payment Details</SideLink>
          <SideLink href="#12">Kids' Privacy</SideLink>
          <SideLink href="#13">Changes To Our Privacy Policy</SideLink>
          <SideLink href="#14">Third-Party Services</SideLink>
          <SideLink href="#15">
            Information about General Data Protection Regulation (GDPR)
          </SideLink>
          <SideLink href="#16">What is GDPR?</SideLink>
          <SideLink href="#17">What is personal data?</SideLink>
          <SideLink href="#18">Why is GDPR important?</SideLink>
          <SideLink href="#19">
            Individual Data Subject's Rights - Data Access, Portability and
            Deletion
          </SideLink>
          <SideLink href="#20">California Residents</SideLink>
          <SideLink href="#21">Contact Us</SideLink>
        </LeftColumn>
        <RightColumn>
          <Text>
            Quantum IO (“we,” “our,” or “us”) is committed to protecting your
            privacy. This Privacy Policy explains how your personal information
            is collected, used, and disclosed by Quantum IO.
            <br />
            <br />
            ...
            Quantum IO. By accessing or using our Service, you signify that you
          ...
          <Heading id="1">Definitions and key terms</Heading>
          <Text>
            ...
            <ul>
              ...
              <li>
                ...
                signs up to use the Quantum IO Service to manage the
              ...
              <li>
                ...
                Quantum IO or are under contract to perform a service on behalf
          ...
          <Heading id="2">Information automatically collected</Heading>
          <Text>
          ...
          <Heading id="3">Personnel</Heading>
          <Text>
            If you are a Quantum IO worker or applicant, we collect information
          ...
          <Heading id="4">Sale of Business</Heading>
          <Text>
            ...
            all of the assets of Quantum IO or any of its Corporate Affiliates
            (as defined herein), or that portion of Quantum IO or any of its
          ...
          <Heading id="5">Affiliates</Heading>
          <Text>
            ...
            control with Quantum IO, whether by ownership or otherwise. Any
          ...
          <Heading id="6">Governing Law</Heading>
          <Text>
            ...
            <br />
            <br />
            By using Quantum IO or contacting us directly, you signify your
          ...
          <Heading id="11">Payment Details</Heading>
          <Text>
          ...
          <Heading id="12">Kids' Privacy</Heading>
          <Text>
          ...
          <Heading id="13">Changes To Our Privacy Policy</Heading>
          <Text>
          ...
          <Heading id="14">Third-Party Services</Heading>
          <Text>
          ...
          <Heading id="16">What is GDPR?</Heading>
          <Text>
          ...
          <Heading id="17">What is personal data?</Heading>
          <Text>
          ...
          <Heading id="18">Why is GDPR important?</Heading>
          <Text>
            ...
            the right thing to do. At Quantum IO we strongly believe that your
          ...
          <Text>
            ...
            rights requirements of GDPR. Quantum IO processes or stores all
            ...
            you! We've been set up as self service from the start and have
          ...
          <Heading id="20">California Residents</Heading>
          <Text>
          ...
          <Heading id="21">Contact Us</Heading>
          <Text>
